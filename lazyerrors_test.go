...
func TestShortPath(t *testing.T) {
	...
	assertEqual(t, "/absolute/path/lazyerrors.go", shorten("/absolute/path/lazyerrors.go", -1))
	assertEqual(t, "", shorten("/absolute/path/lazyerrors.go", 0))
	assertEqual(t, "lazyerrors.go", shorten("/absolute/path/lazyerrors.go", 1))
	assertEqual(t, "path/lazyerrors.go", shorten("/absolute/path/lazyerrors.go", 2))
	assertEqual(t, "absolute/path/lazyerrors.go", shorten("/absolute/path/lazyerrors.go", 3))
	assertEqual(t, "/absolute/path/lazyerrors.go", shorten("/absolute/path/lazyerrors.go", 4))
	assertEqual(t, "/absolute/path/lazyerrors.go", shorten("/absolute/path/lazyerrors.go", 5))

	assertEqual(t, "/lazyerrors.go", shorten("/lazyerrors.go", -1))
	assertEqual(t, "", shorten("/lazyerrors.go", 0))
	assertEqual(t, "lazyerrors.go", shorten("/lazyerrors.go", 1))
	assertEqual(t, "/lazyerrors.go", shorten("/lazyerrors.go", 2))

	assertEqual(t, "relative/path/lazyerrors.go", shorten("relative/path/lazyerrors.go", -1))
	assertEqual(t, "", shorten("relative/path/lazyerrors.go", 0))
	assertEqual(t, "lazyerrors.go", shorten("relative/path/lazyerrors.go", 1))
	assertEqual(t, "path/lazyerrors.go", shorten("relative/path/lazyerrors.go", 2))
	assertEqual(t, "relative/path/lazyerrors.go", shorten("relative/path/lazyerrors.go", 3))
	assertEqual(t, "relative/path/lazyerrors.go", shorten("relative/path/lazyerrors.go", 4))
	assertEqual(t, "relative/path/lazyerrors.go", shorten("relative/path/lazyerrors.go", 5))
